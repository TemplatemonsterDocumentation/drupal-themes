...
<p>According to the Cookie Law, your website should use a proper module that displays notifications about the cookie
	usage on the site. You can use the the following modules: <strong>TM Cookie Notice</strong> (available in the
	downloaded Drupal template package), <strong><a href="//www.drupal.org/project/eu_cookie_compliance">EU Cookie
	Compliance</a></strong>, <strong><a href="https://www.drupal.org/project/cookiecontrol">Cookie
	Control</a></strong>.</p>