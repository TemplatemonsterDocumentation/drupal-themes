...
<p class="alert alert-info">
	<span>The <strong>TM Block Background</strong> module controls the activation/deactivation of the video background effect for blocks.</span>
</p>
...
<ol class="index-list">
	<li>
		Open the theme settings: in the admin panel navigate to <strong>Appearance > Settings > Theme### </strong> menu.
	</li>
	<li>
	...
	<li>
		Create a new block: in the admin panel navigate to <strong>Structure > Blocks > Add block </strong> menu or in a browser's address bar type 
		<strong>http://www.example.com/?q=admin/structure/block/add</strong>, where <strong>www.example.com</strong> is your website URL.
	</li>
	<li>
	...
	<li>
		In the <strong>Region settings</strong> section for the installed theme select the region you've edited at the step 3.
	</li>
	<li>
