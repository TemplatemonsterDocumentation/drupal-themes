...
<h4>Method #1.</h4>
<ol class="index-list">
    <li>Open the theme settings: in the admin panel navigate to <strong>Appearance > Settings >
            Theme### </strong> menu.
    </li>
    ...
    <li>Create a new block: in the admin panel navigate to <strong>Structure > Blocks > Add block </strong>
    ...
    <li>In the <strong>Region settings</strong> section for the installed theme select the region you've edited at the
        step 3.
    </li>
    <li>
        ...
        <ul class="marked-list">
            <li>in the <strong>Background type</strong> field choose <strong>
                    <em>image</em>
                    value</strong>;
            </li>
            <li>in the <strong>Background image</strong> field upload the required image or select it from the media
                library;
            </li>
...
<ol class="index-list">
    ...
    <li>Navigate to <strong>Structure > Blocks</strong> menu or in a browser's address bar type <strong>http://www.example.com/?q=admin/structure/block</strong>,
        where <strong>www.example.com</strong> is your website URL.
    </li>
