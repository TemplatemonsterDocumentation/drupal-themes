...
<p>To change the "Social Share" block settings for the <strong>Blog Entry</strong> content type, follow the instructions
    below:</p>
<ol class="index-list">
    <li>In the admin panel open <strong> Structure > Content types > Blog entry </strong> menu and navigate to
    ...
    <li>Check <strong>Full content</strong> option.</li>
    <li>Click the gear wheel icon next to the <strong>AddThis</strong> field.</li>
    <li>Change the names of the sharing services (the full list of names is available on the site <a
...
<p>To remove "Social Share" buttons from the <strong>Blog Entry</strong> content type, follow the instructions below:
</p>
<ol class="index-list">
    <li>In the admin panel open <strong> Structure > Content types > Blog entry </strong> menu and navigate to
    ...
    <li>Click <strong>delete</strong> link next to the <strong>AddThis</strong> field and confirm the action.</li>
</ol>
<figure class="img-polaroid">
...
<ol class="index-list">
    <li>In the admin panel open <strong> Structure > Content types > Content type name</strong> menu, where
        Content type name is the name of the needed content type.
    </li>
    <li>Navigate to <strong>Manage fields</strong> tab.</li>
    <li>
        ...
        <ul class="marked-list">
            ...
            <li>
                <dl class="inline-term">
                    ...
                    <dd>a form element type for the field managing, select <strong>
                            <em>AddThis button</em>
                        </strong> value.
                    </dd>
                </dl>
            </li>
    ...
    <li>To edit the buttons design, follow the steps for configuring "Social Share" buttons for the
        <em>Blog entry</em>
        content type.
    </li>
</ol>