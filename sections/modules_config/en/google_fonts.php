...
<ol class="index-list">
	...
	<li>
		Via any text editor (f.e., <strong><em>notepad</em></strong>, <strong><em>notepad++</em></strong>, etc.) open 
		<strong>sites\all\themes\theme###\less\style.less</strong> file, where <strong>theme###</strong> is the number of the downloaded theme.
	</li>
	<li>
