...
<p class="alert alert-info">
	<span>За включение/отключение постепенной подгрузки изображений отвечает модуль <strong>TM Lazy Load</strong>.</span>
</p>
<p>Для настройки постепенной подгрузки изображений выполните следующие действия:</p>
<ol class="index-list">
	<li>
		В панели администрирования зайдите на страницу <strong>Configuration > TM Lazyload (Настройка > TM
		...
		<ul class="marked-list">
			...
			<li>
				<dl class=" inline-term">
					...
					<dd>расстояние от изображения до видимой части окна браузера перед тем, как изображение загрузится.</dd>
				</dl>
			</li>
			<li>
				<dl class=" inline-term">
	...
	<li>
		<p>После того, как все необходимые изменения будут сделаны, нажмите кнопку <strong>Save (Сохранить)</strong>.</p>
