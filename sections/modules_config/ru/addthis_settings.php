...
<ol class="index-list">
    <li>В панели администрирования зайдите на страницу <strong> Structure > Content types > Blog entry
    ...
    <li>Выберите пункт <strong>Full content (Полная страница)</strong>.</li>
    <li>Нажмите на пиктограмму шестеренки напротив поля <strong>AddThis</strong>.</li>
    <li>Измените набор иконок (полный список доступен на <a
...
<ol class="index-list">
    ...
    <li>Нажмите на ссылку <strong>delete (удалить)</strong> напротив поля <strong>AddThis</strong>, после чего
...
<ol class="index-list">
    <li>В панели администрирования зайдите на страницу <strong> Structure > Content types > Content type name
            (Структура > Типы материалов > Имя типа материала)</strong>, где Content type name - имя
        необходимого типа материала.
    </li>
    <li>Перейдите на вкладку <strong>Manage fields (Управление полями)</strong></li>
    <li>
        ...
        <ul class="marked-list">
            ...
            <li>
                <dl class="inline-term">
                    <dt>машинное имя</dt>
                    <dd>служебное название поля, генерируется автоматически, однако при необходимости вы можете
                        изменить его;
                    </dd>
                </dl>
            </li>
            <li>
                <dl class="inline-term">
                    ...
                    <dd>тип данных, здесь необходимо выбрать <strong>
                            <em>AddThis</em>
                        </strong>;
                    </dd>
                </dl>
            ...
            <li>
                <dl class="inline-term">
                    ...
                    <dd>тип элемента формы для управления полем, выберите <strong>
    ...
    <li>Для настройки внешнего вида кнопок выполните действия, аналогичные действиям при настройке кнопок "Поделиться"
        для типа материала
        <em>Blog entry (Запись блога)</em>
        .
    </li>
</ol>