...
<p class="alert alert-info"><span>За включение/отключение эффекта видео на фоне для блоков отвечает модуль <strong>TM Block Background</strong>.</span></p>
<p>Создать блок с эффектом видео на фоне можно двумя способами.</p>
<h4>Способ №1.</h4>
<ol class="index-list">
    <li>Зайдите в настройки темы: в панели администрирования откройте страницу <strong>Appearance > Settings > Theme### (Внешний вид > Настройки > Theme###)</strong>.</li>
    <li>Перейдите на вкладку <strong>Regions Settings (Настройки регионов)</strong>.</li>
    <li><p>В подходящем регионе поставьте галочку в поле <strong>Fullwidth (На всю ширину экрана)</strong>.</p>
        <figure class="img-polaroid"><img src="img/parallax-settings-01.png" alt="Make region fullwidth"></figure>
    </li>
    <li>Сохраните настройки.</li>
    <li>Создайте новый блок: в панели администрирования зайдите на страницу <strong>Structure > Blocks > Add block (Структура > Блоки > Добавить блок)</strong> или в адресной строке браузера наберите <strong>http://www.example.com/?q=admin/structure/block/add</strong>, где <strong>www.example.com</strong> - адрес вашего сайта.</li>
    <li><p>Поместите содержимое блока между тегами </p>
        ...
        <p>и</p>
        <code>&lt;/div&gt;&lt;/div&gt;</code>
        <figure class="img-polaroid"><img src="img/parallax-settings-02.png" alt="Add grids to block body"></figure>
    </li>
    <li>В блоке <strong>Region settings (Настройка региона)</strong> в поле с установленной темой укажите регион, отредактированный в п.3.</li>
    <li>
...
<ol class="index-list">
    ...
    <li>Перейдите на страницу <strong>Structure > Blocks (Структура > Блоки)</strong> или в адресной строке браузера наберите <strong>http://www.example.com/?q=admin/structure/block</strong>, где <strong>www.example.com</strong> - адрес вашего сайта.</li>
