...
<p class="alert alert-info">
	<span>За включение/отключение эффекта параллакса для блоков отвечает модуль <strong>TM Block Background</strong>.</span>
</p>
...
<ol class="index-list">
	<li>
		Зайдите в настройки темы: в панели администрирования откройте страницу <strong>Appearance > Settings >
	...
	<li>
		Создайте новый блок: в панели администрирования зайдите на страницу <strong>Structure > Blocks > Add
	...
	<li>
		В блоке <strong>Region settings (Настройка региона)</strong> в поле с установленной темой укажите регион,
	...
	<li>
		...
		<ul class="marked-list">
			<li>в поле <strong>Background type (Тип фона)</strong> укажите <strong> <em>image (изображение)</em></strong>;</li>
			<li>в поле <strong>Background image (Фоновое изображение)</strong> загрузите необходимое изображение или выберите его из библиотеки изображений;</li>
...
<ol class="index-list">
	...
	<li>
		...
		<ul class="marked-list">
			<li>в поле <strong>Background type (Тип фона)</strong> укажите <strong> <em>image (изображение)</em></strong>;</li>
			<li>в поле <strong>Background image URL (Путь к фоновому изображению)</strong> загрузите необходимое изображение или выберите его из библиотеки изображений;</li>
			<li>поставьте галочку в поле <strong>Use parallax (Использовать параллакс)</strong>.</li>
		</ul>
	</li>
	<li>
	...
	<li>
		Перейдите на страницу <strong>Structure > Blocks (Структура > Блоки)</strong> или в адресной строке
