...
<ol class="index-list">
    <li>Распакуйте архив со скачанной темой на свой компьютер.</li>
    <li>Откройте в текстовом редакторе (например, <strong><em>notepad</em></strong>, <strong><em>notepad++</em></strong> и т.п.) файл <strong>sites\all\themes\theme###\less\style.less</strong>, где <strong>theme###</strong> - номер скачанной вами темы.</li>
    <li>
    ...
    <li>Перезалейте измененный файл на свой хостинг.</li>
</ol>