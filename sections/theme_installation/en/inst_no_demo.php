...
<ol class="index-list">
	<li>
		<p>Copy all content of <strong>sample_data/sites/all/themes/</strong> folder from the template package to
			<strong>sites/all/themes/</strong> directory of the Drupal installation on your server.</p>
	...
	<li>
		To install modules copy the content of <strong>sample_data/sites/all/modules/</strong> and <strong>sample_data/sites/all/libraries/</strong>
	...
	<li>
		<p>On the initial setup page you will need to select the installation profile. Choose <strong>Standard</strong> and
		click <strong>Save and Continue</strong> button:</p>
	...
	<li>
		<p>On the next step fill in the fields with your database name, username, password and hostname of the previously
		created database.</p>
	...
	<li>
		...
		password specified on the previous step.</p>
	...
	<li>
		In the admin panel navigate to <strong>Appearance</strong> menu or in a browser's address bar type <strong>http://www.example.com/?q=admin/appearance</strong>,
		where <strong>www.example.com</strong> is your website URL.
	</li>
	<li>
		<p>Find your installed theme and click <strong>Enable and set default</strong>.</p>
	...
	<li>
		In case you've uploaded the modules folder on the second installation step, navigate to <strong>Modules</strong>
		...
		information you can check in the <a href="?lang=en&section=modules_config#modules_settings">"Configuring modules"</a> section.
	</li>
</ol>
<p>Feel free to check the following instructions: </p>
<ul class="marked-list">
	<li>
		<a href="/help/ru/how-upload-and-install-drupal-server.html" target="_blank">Drupal 7.x. How to install the
		engine</a>
	<li>
		<a href="/help/ru/how-to-install-drupal-7-theme.html" target="_blank">Drupal 7.x. How to install Drupal theme</a>
	</li>
</ul>