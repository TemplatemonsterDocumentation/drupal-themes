...
<ol class="index-list">
	<li>
		<p>Copy content of <strong>sample_data/sites/all/themes/</strong> folder from the template package to <strong>sites/all/themes/</strong>
	...
	<li>
		...
		information you can check in <a href="?lang=en&section=modules_config#modules_settings">"Configuring modules"</a> section.
	</li>
</ol>
