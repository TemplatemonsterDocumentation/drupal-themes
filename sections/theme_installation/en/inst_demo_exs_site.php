...
<ol class="index-list">
    <li>Copy content of <strong>sample_data/sites/all/</strong> folder from the template package to
        <strong>sites/all/</strong> directory of the Drupal installation on your server.
    </li>
    <li>Copy content of <strong>sample_data/sites/default/</strong> folder from the template package to <strong>sites/default/</strong>
        directory of the Drupal installation on your server.
    </li>
    <p class="alert alert-danger">
    ...
    <li>In the admin panel navigate to <strong>Configuration > File system</strong> menu or follow the link
    ...
    <li>In the <strong>Private file system path</strong> field set <strong>sites/default/private/files</strong> value.
    </li>
    <li>Then in the admin panel open <strong>Modules</strong> menu or follow the link <strong>http://www.example.com/?q=admin/modules</strong>,
        where <strong>www.example.com</strong> is your website URL.
    </li>
    <li>Make sure that <strong>Demonstration site</strong> module is enabled.</li>
    <li>In the admin panel navigate to <strong>Structure > Snapshots</strong> menu, open <strong>Reset </strong>
    ...
    <li>Select the <strong>theme###</strong> snapshot, where ### is the number of your theme.</li>
    <figure class="img-polaroid">
        <img src="img/inst-demo-exs-site-01.png" alt="Select snapshot">
    </figure>
    <li>Click <strong>Reset</strong> button. Confirm the action.</li>
    <li>Log in to Drupal website as administrator.</li>
    <p class="alert alert-warning">
    ...
    <li>The last thing to do is to update the database tables. In a browser's address bar type <strong>http://www.example.com/update.php</strong>,
        where <strong>www.example.com</strong> is your website URL.
    </li>
...
<ul class="marked-list">
    <li><a href="/help/ru/how-to-install-drupal-7-theme.html" target="_blank">Drupal 7.x. How to install a theme

        </a>
    <li><a href="/help/ru/how-to-install-drupal-7-theme-sample-data.html" target="_blank">Drupal 7.x. How to install
            sample data
