...
<ol class="index-list">
	<li>
		Скопируйте содержимое папки <strong>sample_data/sites/all/</strong> из архива с шаблоном в папку <strong>sites/all/</strong>
		Drupal-сайта на вашем сервере.
	</li>
	<li>
		<p>Скопируйте содержимое папки <strong>sample_data/sites/default/</strong> из архива с шаблоном в папку <strong>sites/default/</strong>
	...
	<li>
		В панели администрирования сайта зайдите на страницу <strong>Configuration > File system (Настройки >
	...
	<li>
		В поле <strong>Private file system path (Конфиденциальный путь файловой системы)</strong> установите значение
		<strong>sites/default/private/files</strong>.
	</li>
	<li>
		Зайдите на страницу <strong>Modules (Модули)</strong> панели администрирования или перейдите по ссылке <strong>http://www.example.com/?q=admin/modules</strong>,
		где <strong>www.example.com</strong> - адрес вашего сайта.
	</li>
	<li>
		Убедитесь, что модуль <strong>Demonstration site</strong> включен.
	</li>
	<li>
		Зайдите на страницу <strong>Structure > Snapshots (Структура > Снапшоты)</strong> панели
	...
	<li>
		<p>Выберите снапшот <strong>theme###</strong>, где ### - номер приобретенной вами темы.</p>
	...
	<li>
		Нажмите кнопку <strong>Reset (Восстановить)</strong>. Затем подтвердите действие.
	</li>
	<li>
		<p>Войдите на сайт в качестве администратора.</p>
	...
	<li>
		Последнее, что необходимо сделать, - обновить таблицы базы данных. В адресной строке браузера введите <strong>http://www.example.com/update.php</strong>,
		где <strong>www.example.com</strong> - адрес вашего сайта.
	</li>
	<li>
...
<ul class="marked-list">
	...
	<li>
		<a href="/help/ru/how-to-install-drupal-7-theme-sample-data.html" target="_blank">Drupal 7.x. Как установить демонстрационные данные</a>
	</li>
</ul>