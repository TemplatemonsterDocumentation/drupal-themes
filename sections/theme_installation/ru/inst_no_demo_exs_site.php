...
<ol class="index-list">
	...
	<li>
		<p>Найдите только что добавленную тему и нажмите кнопку <strong>Enable and set default (Активировать и
			установить по умолчанию)</strong>.</p>
	...
	<li>
		Если на втором шаге вы добавили папки с модулями, зайдите на страницу <strong>Modules (Модули)</strong> в панели
		...
		href="?lang=ru&section=modules_config#modules_settings">"Настройка модулей"</a>
	</li>
</ol>
