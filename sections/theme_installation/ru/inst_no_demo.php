...
<ol class="index-list">
    ...
    <li>Введите адрес вашего сайта в адресной строке браузера, чтобы начать процедуру установки Drupal (см. скриншоты,
        демонстрирующие следующие три шага, в слайдере, после п. 6).
    </li>
    <li>На начальной странице установки вам будет предложено выбрать профиль установки. Выберите <strong>Standard
            (Стандартный)</strong> и нажмите кнопку <strong>Save and Continue (Сохранить и продолжить)</strong>:
    </li>
    <li>На следующем шаге заполните поле имени, имени пользователя, пароля и хоста базы данных, полученных при ее
        создании.
    </li>
    <li>Зарегистрируйте администратора сайта.</li>
</ol>

<ol class="index-list">
    <li>
        <p>Выберите
            <em>Standard (Стандартный).</em>
        </p>
    ...
    <li>
        <p>Заполните поле имени базы данных, имени пользователя, пароля и хоста базы данных.</p>
    ...
    <li>
        <p>Перейдите на установленный сайт.</p>
...
<ol class="index-list">
    <li>Нажмите на ссылку <strong>Visit your new site (Посетите свой новый сайт)</strong> или в адресной строке браузера
        наберите <strong>http://www.example.com/?q=user/login</strong>, где <strong>www.example.com</strong> - адрес
        вашего сайта. Для входа на сайт используйте имя пользователя и пароль, указанные в предыдущем шаге.
    </li>
    ...
    <li>Найдите только что добавленную тему и нажмите кнопку <strong>Enable and set default (Активировать и установить
            по умолчанию)</strong>.
        <figure class="img-polaroid">
            <img src="img/inst-no-demo-01.png" alt="Enable theme">
        </figure>
    </li>
    <li>Если на втором шаге вы скопировали папки с модулями, зайдите на страницу <strong>Modules (Модули)</strong> в
        ...
        информации смотрите раздел <a href="#modules_settings">"Настройка модулей"</a>.
    </li>
</ol>
<p>Вы можете просмотреть следующие инструкции: </p>
<ul class="marked-list">
    <li><a href="/help/ru/how-upload-and-install-drupal-server.html" target="_blank">Drupal 7.x. Как установить движок
