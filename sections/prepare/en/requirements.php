...
<p>To install and run Drupal your hosting server should meet the engine requirements. Most of the hosting companies meet
    the standards. However, there can be exceptions, that is why you should check the following properties.
</p>
...
<p>Apache, Nginx или Microsoft IIS.<br>
...
<p class="alert alert-info">
    <span>When installing Drupal, please note that some of the modules may not support PostgreSQL and SQLite databases, moreover template configuration and sample data are stored in MySQL format. That is why it is recommended to use MySQL database only.</span>
</p>

<h4>PHP</h4>
PHP 5.2.5 or higher (5.3 recommended).<br>
<a href="https://drupal.org/requirements/php" target="_blank">More details about PHP requirements.</a>
<h4>Validation</h4>
