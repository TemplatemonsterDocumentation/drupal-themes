...
<ul class="marked-list">
    <li><strong>Main menu</strong> contains the links to the main website pages;</li>
    <li><strong>User menu</strong> contains the links related to the user's account, such as "Register", "Login", etc.;
    </li>
    <li><strong>Footer menu</strong> duplicates the main menu.</li>
</ul>
...
<ol class="index-list">
    ...
    <li>Find the block with this menu title.</li>
    <li>Click <strong>Configure</strong> link next to the block.</li>
    <li><p>Make changes in the <strong>Superfish settings </strong> section.</p>

        <figure class="img-polaroid">
            <img src="img/menu-manage-06.png" alt="Fill Superfish settings">
        </figure>
    </li>
    <li>Press <strong>Save block</strong> button.</li>
</ol>
...
<ol class="index-list">
    ...
    <li>Find the block with this menu title.</li>
    <li>Move the block to the needed region, the same way as a regular block.</li>
    <li>Press <strong>Save blocks</strong> button.</li>
</ol>
...
<ol class="index-list">
    ...
    <li>
        ...
        <ul class="marked-list">
            <li><strong>Menu</strong> - the name of the menu that needs to be duplicated;</li>
            <li><strong>Starting level</strong> - block visibility on a page. Blocks that start from the first level
            ...
            <li><strong>Maximum depth</strong> - the number of the visible menu levels. Set 1 value to disable all
                sub-menus.
            </li>
        </ul>
    </li>
    <li><p>Press <strong>Save block</strong> button.</p>
...
<ul class="marked-list">
    <li><a target="_blank" href="/help/ru/drupal-7-how-to-install-drop-down-menu-module.html"> Drupal 7. How to install
            drop-down menu module (Superfish)
            <i class="icon-external-link"></i>
        </a></li>
    <li><a href="/help/ru/drupal-7-how-to-add-a-new-page-and-a-new-menu-button.html" target="_blank"> Drupal 7. How to
            add a new page and a new menu item
            <i class="icon-external-link"></i>
        </a></li>
    <li><a href="https://drupal.org/node/754652" target="_blank">Superfish module documentation
            <i class="icon-external-link"></i>
        </a></li>
</ul>