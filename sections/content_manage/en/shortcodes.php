...
<p><strong>[clear][/clear]</strong> - clears floated blocks. The shortcode contains the following attributes:
</p>
...
<p><strong>[col][/col]</strong> - displays content in columns. The shortcode contains the following attributes:
</p>
...
<ul class="marked-list">
    <li>
        <dl class="inline-term">
            ...
            <dd>columns alignment:
                <em>right</em>
                - a column will appear at the right side of the external block,
                <em>center</em>
                - a column will appear at the center of the external block;
            </dd>
        </dl>
    </li>
    <li>
    ...
    <li>
        <dl class="inline-term">
            ...
            <dd>clears floated blocks:
                <em>clear-both</em>
                - on both sides,
                <em>clear-left</em>
                - on the left side only,
                <em>clear-right</em>
                - on the left right only;
            </dd>
        </dl>
    </li>
    <li>
    ...
    <li>
        <dl class="inline-term">
            ...
            <dd>column width:
                ...
                - a sixth or
                <em>5-6</em>
                - five sixths external blocks.
            </dd>
        </dl>
    </li>
</ul>
<p>It is recommended to use this shortcode inside
    <strong>
        <em>[clear][/clear]</em>
    </strong>
    hortcode.
...
<p>For example:</p>
<pre><code>[gmap lat_coord="41.850033" lng_coord="-87.6500523" zoom_value="15" zoom_wheel="no"
        class="custom-class"][/gmap]</code></pre>
<p>Possible use cases:</p>
...
<p>For example:</p>
<pre><code>[piegraph percent="60" width="200" barcolor="#21c2f8" trackcolor="#cccccc"
        linewidth="3"]Title[/piegraph]</code></pre>
<p>Possible use cases:</p>
