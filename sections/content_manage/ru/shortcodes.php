...
<ul class="marked-list">
    <li>
        <dl class="inline-term">
            <dt>align</dt>
            <dd>выравнивание колонки:
                <em>right</em>
                - колонка будет отображаться с правой стороны внещнего блока,
                <em>center</em>
                - колонка будет выровнена по центру внешнего блока;
            </dd>
        </dl>
    </li>
    <li>
    ...
    <li>
        <dl class="inline-term">
            <dt>clear</dt>
            <dd>очистка плавающих элементов:
                <em>clear-both</em>
                - слева и справа,
                <em>clear-left</em>
                - только слева,
    ...
    <li>
        <dl class="inline-term">
            ...
            <dd>ширина колонки:
                ...
                - одна шестая или
                <em>5-6</em>
                - пять шестых ширины внешнего блока.
            </dd>
        </dl>
    </li>
</ul>
<p>Данный шоткод рекомендуется использовать внутри шоткода <strong>
        <em>[clear][/clear]</em>
    </strong>.
</p>
...
<p><strong>[counter][/counter]</strong> - шоткод для отображения анимированных счетчиков. Имеет следующие
    атрибуты:</p>
...
<pre><code>[piegraph percent="60" width="200" barcolor="#21c2f8" trackcolor="#cccccc"
        linewidth="3"]Заголовок[/piegraph]</code></pre>
