...
<ul class="marked-list">
    <li>
        <dl class="inline-term">
            <dt>Archive (Архив)</dt>
            <dd>собирает тип материала "Blog entry" (Запись блога), группирует их по месяцам года и выводит в виде
                блока или страницы.
            </dd>
        </dl>
    </li>
    ...
    <li>
        <dl class="inline-term">
            ...
            <dd>собирает термины таксономии из словаря
                <em>"Blog categories" (Категории блога)</em>
                и выводит их в виде блока.
            </dd>
        </dl>
    </li>
    <li>
    ...
    <li>
        <dl class="inline-term">
            ...
            <dd>собирает записи материала типа "Portfolio Item" (Элемент портфолио) и выводит их в виде страниц
                Portfolio (Gallery, Services) в две, три или четыре колонки.
            </dd>
        </dl>
    </li>
    <li>
...
<ol class="index-list">
    <li>Чтоб просмотреть все существующие представления, в панели администрирования зайдите на страницу <strong>Structure >
    ...
    <li><p>Чтобы создать новое представление, нажмите на ссылку <strong>Add new view (Добавить новое
    ...
    <li>На открывшейся странице заполните название представления, тип материала, вид сортировки, в каком виде
        отображать.
    </li>
    <li><p>Чтобы указать дополнительные параметры, нажмите кнопку <strong>Continue &amp; edit (Продолжить и
    ...
    <li><p>Чтобы отредактировать существующее представление, выберите пункт <strong>Edit (Редактировать)</strong> в
    ...
    <li><p>Чтобы удалить существующее представление, выберите пункт <strong>Delete (Удалить)</strong> в выпадающем
            списке
            напротив нужного представления.</p>

        <figure class="img-polaroid">
            <img src="img/views-manage-04.png" alt="Click 'Delete'">
        </figure>
    </li>
    <li><p>Представлениями, которые отображены в виде блоков, можно управлять так же, как и обычными блоками. Вы также
            ...
            выберите
            пункт <strong>Configure block (Настроить блок)</strong>:</p>

        <figure class="img-polaroid">
            <img src="img/views-manage-05.png" alt="Click 'Edit view'">
        </figure>
    </li>
    <li><p>Аналогичным образом настраиваются представления, которые отображены в виде страниц. Наведите курсор мышки на
            область содержимого нужной вам страницы, затем нажмите на пиктограмму шестеренки в правом верхнем углу
            страницы
            и выберите пункт <strong>Edit view (Настроить представление)</strong>:</p>
...
<ul class="marked-list">
    <li><a target="_blank" href="/help/ru/drupal-7-how-to-use-views-module-and-editconfigure-it.html"> Drupal 7. Как
            использовать и настраивать модуль отображения контента
